...
/**
 * 瀑布流
 * https://pub.dartlang.org/packages/flutter_staggered_grid_view#-readme-tab-
 */
...
List<IntSize> _createSizes(int count) {//随机设置宽高
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new StaggeredGridView.countBuilder(
        ...
        itemBuilder: (context, index) => new _Tile(index, _sizes[index]),//item文字和图片部分
        staggeredTileBuilder: (index) => new StaggeredTile.fit(2),//crossAxisCellCount  列数
      ),
    );
  }
}
